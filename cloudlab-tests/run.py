...
from Parser import parse_latency_sample, parse_jitter_sample, parse_throughput_samples, save_samples_file
...
def main():
    ...
    while len(throughput_samples) < 3:
    ...
    while len(throughput_samples_ebpf) < 3:
